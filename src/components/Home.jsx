...
const Home = () => {
  ...
  return (
    <div className="md:flex relative flex-row-reverse">
      <div className="w-full md:w-1/2  flex justify-center align-center relative overflow-hidden">
        <div
          className="absolute top-10 md:top-0 w-[350px] h-[350px] md:w-[600px] md:h-[600px] rounded-full bg-gradient-to-r from-[#e200ff] to-[#8400ff] -z-10 rotate-45 "
          style={{ boxShadow: "0px 0px 2rem #8400ff" }}
        ></div>
        <img src={rishi} alt="profile img" className="w-[300px] fade-up md:w-[400px]" />
      </div>
      <div className="w-full md:w-1/2  py-5 px-5 md:py-20 relative">
        <h1 className="text-4xl font-extrabold">
          Hi , i'm{" "}
          <span className="text-shadows-pink text-[#0b001a]">Rishi</span>
        </h1>
        ...
        <div className="relative w-full ">
          ...
          {/* Github link Button  */}
          <div className="Social-links fade-up  inline-block absolute -top-2 right-0">
